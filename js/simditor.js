...
ImageButton = (function(superClass) {
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $($input).appendTo($uploadItem)
      };
    })(this);
    createInput();
  ...
  ImageButton.prototype.loadImage = function($img, src, callback,sss=false) {
    ...
    img.onload = (function(_this) {
      return function() {
        ...
        if (src.indexOf("http://") == 0 || src.indexOf("https://") == 0) {
          ...
          CustomeClass='custm loader_image';
          src=''; 
        }
        $img.attr({
          src: src,
        ...
        }).removeClass('loading').addClass(CustomeClass).css({'width':width,'height':height}).parent().css({'width':width,'height':height,'position':'relative'});
        if ($img.hasClass('uploading')) {
...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype._resizeImg = function(inputEl, onlySetVal) {
    ...
    if (inputEl.is(this.widthEl)) {
      ...
      {
      	width = 680;
      	height = this.height * 680 / this.width;
      }else{
      ...
      {
      	height = 460;
      	width = this.width * 460 / this.height;
      }else{
